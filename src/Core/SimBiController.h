...
*/
	...
	RigidBody* lFoot;
	RigidBody* rFoot;
	RigidBody* lFrontFoot; //jaseem
	RigidBody* rFrontFoot;
...
*/
	...
	RigidBody* swingFoot;
	RigidBody* stanceFrontFoot; //jaseem
	RigidBody* swingFrontFoot;
	//keep track of the swing and stance hip indices
	int stanceHipIndex;
	int swingHipIndex;
	int stanceShoulderIndex; //jaseem
	int swingShoulderIndex;
